...
if(isset($_SESSION['user'])){
    ...
    if(isset($_POST['submit_valid_resv_moto'])){
        ...
        if($id_user){
            ...
            $reserv = $aj->Reservation_moto_Ajout($id_user,$id_reserv_moto,$date_rdv);
            $alert=1;
        }else{ $alert=2;}
    }
    ?>
    <section class="py-5 text-center container titre_page">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                <h2 class="fw-light titre_page ">Reserver une moto</h2>
                <p class="lead text-muted">
                    Vous pouvez par ici réserver un rendez vous pour une moto.
