                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="card-prix">Prix : <?php print  $format = number_format($voiture[$i]->prix, 0, ',', ' ');?>€</span>
                            <div class="btn-group">
                ...
                <div class="col">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="card-prix">Prix : <?php print  $format = number_format($moto[$a]->prix, 0, ',', ' ');?>€</span>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-outline-secondary btn_card" data-toggle="modal" data-target="#essayer">Essayer</button>
                                    <!-- modal -->
                                    <div class="modal fade" id="essayer" tabindex="-1" role="dialog" aria-hidden="true">
